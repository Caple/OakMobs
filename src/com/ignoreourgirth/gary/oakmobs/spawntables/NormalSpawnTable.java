...
public class NormalSpawnTable extends SpawnTable {

	int[]     weights = {5, 15, 10, 20, 1};
	EntityType[] mobs = {EntityType.CREEPER, EntityType.SKELETON, EntityType.SPIDER, EntityType.ZOMBIE, EntityType.ENDERMAN};
